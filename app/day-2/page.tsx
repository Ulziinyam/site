...
const Day2 = () => {
  ...
  return (
    <div className='h-screen w-screen text-black grid grid-cols-4 gap-1 p-5 grid-rows-4 z-10'  >
      <motion.div
        className='col-span-4 w-full  justify-center whitespace-nowrap items-start pt-3 italic text-5xl flex'
        variants={splitParentVariants}
        initial='initial'
        whileHover='hover'
      >
        {'Бидний тухай'.split('').map((eachAlphabet: any) => (
